...
Here we will loop through the anal.param file and summarize the data that we want.The user will need to set `t` to the sites they have permission to access. 

```{r Download, echo=FALSE}

#######
# Choose site based on the row number in the anal.param file
t <-2
#######
...
data.dl <- nc_data_dl(collections=collection, username = "dethier", info = "CMMN Data Summary Script")
...
#filter data collected in the spring within the given year range
in.data <- in.data %>% 
